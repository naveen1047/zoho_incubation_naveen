...
@Provider
public class SecurityFilter implements ClientRequestFilter  /*ContainerRequestFilter*/ {
   ...
   /* @Override
    ...
    public void filter(ClientRequestContext requestContext) throws IOException {
        ...
        if (!method.isAnnotationPresent(PermitAll.class)) {
            ...
            //Get request headers
            final MultivaluedMap<String, Object> headers = (MultivaluedMap<String, Object>) requestContext.getHeaders();

            //Fetch authorization header
            final List<Object> authorization = headers.get(AUTHORIZATION_PROPERTY);
            ...
            //Get encoded username and password
            final String encodedUserPassword = authorization.get(0).toString().replaceFirst(AUTHENTICATION_SCHEME + " ", "");
